      ...
      <section id="overview" className="py-24 px-6">
        ...
        <FadeIn delay={0.2} className="mt-12 flex justify-center">
          <motion.button 
            ...
            onClick={() => scrollTo('contact-form')}
            className="bg-blue-600 text-white hover:bg-blue-700 px-10 py-5 rounded-full font-black text-xl transition-all shadow-xl flex items-center justify-center gap-3"
          >
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-black tracking-tight">1644-7157</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-2 text-slate-300 bg-slate-900 px-4 py-2 rounded-full border border-slate-800">
              ...
              <a href="tel:1644-7157" className="font-bold text-white hover:text-blue-400 transition-colors">1644-7157</a>
            </div>
          </div>
